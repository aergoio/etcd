...
var plog = capnslog.NewPackageLogger("github.com/aergoio/etcd", "embed")
...
func stopServers(ctx context.Context, ss *servers) {
	...
	// and https://github.com/aergoio/etcd/issues/8916
	if ss.secure {
		shutdownNow()
		return
	}
